$(function () {
  ...
  function setup() {
    ...
    createCollectable("chicken", 125, 255, 0.5, 0.7);
    createCollectable("chicken", 980, 600, 0.7, 0.7);
    createCollectable("chicken", 1360, 400, 0.6, 0.8);
    createCollectable("winner", 125, 200, 0, 0.7);

    // TODO 4 - Create Cannons
    createCannon("right", 690, 1200);
    createCannon("bottom", 200, 1200);
    createCannon("left", 190, 1700);
    createCannon("bottom", 1270, 1700);
